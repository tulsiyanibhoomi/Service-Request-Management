      ...
      >
        <div className="flex justify-end p-4 gap-4">
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition-all text-lg"
          >
            Download
            <svg
              className="w-6 h-6"
          ...
          <button
            onClick={onClose}
            className="flex items-center justify-center text-white font-bold w-14 h-14 rounded-full px-4 text-4xl shadow-lg transition-all"
          >
            &times;
          </button>
        </div>
        ...
        <div className="flex flex-1 justify-center px-4">
          <div className="flex items-center justify-center w-full max-w-6xl">
            <div className="flex-none">
              <button
                className="text-white text-4xl p-5 hover:text-gray-300 transition-colors"
                onClick={goPrev}
              >
                ‹
              </button>
